<%-- 
    Document   : contact
    Created on : 05-May-2023, 12:10:30 pm
    Author     : HP
--%>
                ...
                <div class="row">
                    <div class="col-12 col-md-7 col-xl-8">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <form action="contact" method="post" class="form form--contacts">
                                    ...
                                    <div class="row row--form form-group">
                                        <div class="col-12 col-xl-6">
                                            <input name="name" type="text" class="form__input form-control" placeholder="Name">
                                        </div>
                                        <div class="col-12 col-xl-6">
                                            <input name="email" type="email" class="form__input form-control" placeholder="Email">
                                        </div>
                                        <div class="col-12">
                                            <input name="subject" type="text" class="form__input" placeholder="Subject">
                                        </div>
                                        <div class="col-12">
                                            <textarea name="message" id="text" class="form__textarea" placeholder="Type your message..."></textarea>
                                        </div>
                                        <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <ul class="contacts__list">
                                    ...
                                    <li><a href="mailto:support@moviego.com">support@movieflix.com</a></li>
                                </ul>
